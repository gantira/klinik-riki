$(document).ready(function() {
	...
	$(window).on('load resize', function() {
		if($(window).innerWidth() < 360) {
			$('.navbar-brand img.logo').attr('src', 'http://localhost/riki/public/diffdash/assets/img/logo-minimal.png');
		} else {
			$('.navbar-brand img.logo').attr('src', 'http://localhost/riki/public/diffdash/assets/img/logo.png');
		}
	});
