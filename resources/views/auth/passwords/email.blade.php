...
<head>
    <title>Recovery Password | {{ config('app.name') }}</title>
    <meta charset="utf-8">
        ...
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle">
                <div class="auth-box forgot-password">
                    <div class="content">
                        <div class="header">
                            <div class="logo text-center"><img src="{{ asset('diffdash/assets/img/logo.png') }}" alt="DiffDash"></div>
                        ...
                        {!! Form::open(['route'=>'password.email', 'method'=>'post', 'class'=>'form-auth-small']) !!}
